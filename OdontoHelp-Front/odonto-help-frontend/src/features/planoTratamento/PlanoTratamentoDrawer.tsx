...
export default function PlanoTratamentoDrawer({
  ...
  const { data: pacientesData, isLoading: pacientesLoading } = usePacientes({ page: 0, size: 100, isAtivo: true }, { staleTime: 0 });
  const pacientes = pacientesData?.content ?? [];

  const { data: dentistasData, isLoading: dentistasLoading } = useDentistas({ page: 0, size: 100, isAtivo: true }, { staleTime: 0 });
                    ...
                    renderInput={(params) => (
                      <TextField
                        ...
                        InputProps={{
                          ...
                          endAdornment: (
                            <>
                              {dentistasLoading ? <CircularProgress color="inherit" size={20} /> : null}
                              {params.InputProps.endAdornment}
                            </>
                          ),
                        }}
                  ...
                  renderInput={(params) => (
                    <TextField
                      ...
                      InputProps={{
                        ...
                        endAdornment: (
                          <>
                            {atendimentosLoading ? <CircularProgress color="inherit" size={20} /> : null}
                            {params.InputProps.endAdornment}
                          </>
                        ),
                      }}
